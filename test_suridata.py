...
def test_duplicate_employee_id_list():
    ...
    clean_employees = validate_and_clean(employees_data)
    assert len(clean_employees) + 1 == len(employees_data), "There should be 6 employees after validation and 7 before"
